---
layout: post
title: "I Tracked My Stress for 90 Days"
description: "What 90 days of HRV tracking revealed about stress and recovery. Learn how heart rate variability can predict stress before you consciously feel it."
date: 2026-01-24
author: "Artie"
keywords: ["hrv", "stress", "recovery", "heart rate variability", "stress tracking"]
image: "/images/2026-01-24.jpg"
canonical_url: "https://harvee.app/blog/i-tracked-my-stress-for-90-days"
show_reading_time: true
tags: ["hrv", "stress tracking", "recovery", "self-experimentation", "data-driven health", "stress management", "heart rate variability", "wellness"]
---
...
HRV was the anchor. Not daily values in isolation, but trends over time, measured under similar conditions. This matters, because HRV reflects how well your nervous system adapts to demands not how "fit" or "disciplined" you are ([Shaffer & Ginsberg, 2017](https://pmc.ncbi.nlm.nih.gov/articles/PMC5624990/)).
...
This aligns neatly with research showing mental load and emotional stress can suppress HRV as much as physical strain ([Thayer et al., 2012](https://pubmed.ncbi.nlm.nih.gov/22178086/)).
...
1. I stopped reacting to single-day changes. Trends mattered. Outliers didn't.
2. I adjusted recovery before burnout showed up. HRV drops became early warnings, not diagnoses.
3. I trusted context more than metrics. Data made sense only when paired with real life.

This is exactly how HRV is meant to be used in research and clinical settings: as a contextual signal, not a verdict ([Shaffer et al., 2014](https://pubmed.ncbi.nlm.nih.gov/25324790/)).
